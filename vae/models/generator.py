...
class GeneratorNetwork(nn.Module):
    ...
    def __init__(self, c_dim, r_dim, z_dim=64, h_dim=128, l=8, share=True):
        super().__init__()
        self.l = l
        self.z_dim = z_dim
        self.h_dim = h_dim
        ...
        inference_args = dict(in_channels=r_dim + c_dim + h_dim, out_channels=h_dim, **kwargs)
    ...
    def forward(self, x, r):
        ...
        for l in range(self.l):
            ...
            hidden_i, cell_i = inference(torch.cat([hidden_g, x, r], dim=1), [hidden_i, cell_i])
            ...
            hidden_g, cell_g = generator(torch.cat([z, r], dim=1), [hidden_g, cell_g])
    ...
    def sample(self, x_shape, r):
        ...
        cell_g = r.new_zeros((batch_size, self.h_dim, h // SCALE, w // SCALE))
